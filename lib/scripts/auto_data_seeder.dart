  ...
  static Future<List<String>> _seedDepartments() async {
    final departments = [
      Departments(
        ...
        code: 'CNTT',
        // description field không tồn tại trong model hiện tại
  ...
  static Future<List<String>> _seedCourseSections(
    ...
    final courseSections = [
      CourseSections(
        ...
        roomId: roomIds[0],
        totalSessions: 15,
        scheduleString: 'Thứ 2, 7:00-9:00',
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
      ),
    ];
  ...
  static Future<void> _seedMakeupRequests(List<String> scheduleIds, List<String> userIds) async {
    for (final scheduleId in scheduleIds) {
      final makeupRequest = MakeupRequests(
        id: '',
        leaveRequestId: scheduleId, // tạm tham chiếu theo schedule
        teacherId: userIds[1],
        proposedStartTime: DateTime(2024, 1, 20, 7, 0),
        proposedEndTime: DateTime(2024, 1, 20, 9, 0),
        proposedRoomId: 'ROOM_PLACEHOLDER',
