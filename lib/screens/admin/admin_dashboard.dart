...
// Import từ cả hai nhánh
import '../../providers/lesson_provider.dart';
import '../../providers/auth_provider.dart';
import '../../services/admin_service.dart';

// Giữ lại cấu trúc StatefulWidget của 'Thanh'
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Widget build(BuildContext context) {
    // =======================================================
    // == BẮT ĐẦU: Thêm lớp bảo vệ (guard) từ nhánh 'HEAD' ==
    // =======================================================
    ...
    // =======================================================
    // == KẾT THÚC: Lớp bảo vệ (guard) của 'HEAD' ==
    // =======================================================

    // Giữ nguyên phần UI còn lại của 'Thanh'
    return Scaffold(
  ...
  // Giữ lại các hàm helper của 'Thanh'
